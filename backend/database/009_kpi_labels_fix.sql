...
-- Author: AKAS Agent
-- Date: 2025-12-28
-- Description: POLISH FIX for Dashboard KPI Function (V3)
-- Fixes: Adds missing 'label' fields to JSON output to prevent "Veri yok" text in UI
-- =============================================
