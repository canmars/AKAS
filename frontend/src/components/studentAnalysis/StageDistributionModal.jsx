...
const StageDistributionModal = ({ isOpen, onClose, stageCode }) => {
    ...
    }, [isOpen, stageCode, pagination.page]);

    const fetchStudents = async () => {
        try {
            setLoading(true);
            setError(null);
            const response = await api.get(`/students/stage-distribution/${encodeURIComponent(stageCode)}`, {
                params: {
            ...
            console.error('Error fetching stage distribution detail:', err);
                            ...
                            <table className="w-full">
                                <thead className="bg-gray-50 border-b border-gray-200">
                                    <tr>
                                        ...
                                        <th className="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Yarıyıl</th>
                                    ...
                                    {students.map((student) => {
                                        ...
                                        return (
                                            <tr key={student.ogrenci_id} className="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-700">{student.mevcut_yariyil || '-'}</td>
...
export default StageDistributionModal;
